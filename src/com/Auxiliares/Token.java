...
public class Token {
	...
	public static final int LITERALFLOAT = 22;
	...
	// operador de atribuicao a adicao
	public static final int AA = 7;
	// operador de atribuicao a subtração
	public static final int AS = 8;
	// operador de deslocamento para esquerda
	public static final int DBE = 9;
